...
It allows users to convert text into different formats such as uppercase, lowercase, title case, or sentence case and translate text from english to urdu. The tool provides real time text preview and makes text manipulation fast and easy directly in the browser.
...
Allow real-time modification of text

Support multiple text formatting options
